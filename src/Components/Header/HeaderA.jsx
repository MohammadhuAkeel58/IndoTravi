    ...
    <>
      ...
      <div className="relative z-10">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 py-4">
          <h1 className="font-semibold text-lg md:text-xl mt-4 font-body text-center md:text-left">
            INDOTRAVI
          </h1>
          ...
          <div className="flex flex-wrap items-center space-x-2 md:space-x-4 md:mt-0 mt-5 justify-center">
